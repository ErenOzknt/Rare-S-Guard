...
const ms = require("ms");
var mutelu = "759555617400291349"; //buraya muteli rolünün id'sini koyunuz
var muteyetkisi = "759521477732204564"; // buraya mute yetkis irolünün id yazınız.
      ...
      if (
        ...
        if (!mutezaman) {
          ...
          setTimeout(async function() {
            muted.removeRole(
              mutelu,
              "Susturulma cezan, sürenin bitmesi sebebiyle kaldırıldı."
            );
          }, ms(mutezaman));
        }
      }
