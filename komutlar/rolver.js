...
exports.run = async (bot, message, args) => {
    ...
    if (!message.member.roles.has("YETKİLİ/İD")) return message.channel.sendEmbed(new Discord.RichEmbed().setDescription('Bu komutu kullanmak için **<@&761106018050113588>** Olman Lazım .').setColor(10038562));
